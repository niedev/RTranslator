...
/**
 * This is a custom TextView variant that uses the system marquee engine to auto scroll
 * the text when it doesn't fit its container.
 * The marquee method auto scroll could be used with XML attributes in the normal TextView,
